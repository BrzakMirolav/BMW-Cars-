...
<div class="sportskidizajn" style="text-align: left; margin-left: 105px">
<h3>Sportski dizajn eksterijera i enterijera modela BMW serije 1.</h3>
        ...
        Kabina impresionira ergonomski optimalizovanim elementima opreme i sistematski primenjenom orijentacijom prema vozaču.
</div> <!--kraj div za tekst kolaz-->
    <br><br>
    <div style="text-align: right"> <!-- div za leve slike kolaz-->
    <img class="pojedinosti" src="slike/tabela2.jpg" alt="BMW 118i" id="drugaSlikaUTabeli" style="width: 550px; height: 470px;">
    <br><br>
    <img class="pojedinosti" src="slike/tabela4.jpg" alt="BMW 118i" id="" style="width:  470px; height:  470px;">
...
<img class="pojedinosti" src="slike/tabela1.jpg" alt="BMW 118i" id="prvaSlikaUTabeli" style="width: 100vh;"> 
<br><br>
<img class="pojedinosti" src="slike/tabela3.jpg" alt="BMW 118i" id="trecaSlikaUTabeli" style=" height: 350px; width: 600px;"> <br><br> 

<img class="pojedinosti" src="slike/tabela5.jpg" alt="BMW 118i" id="petaSlikaUTabeli" style="width: 300px; height: 350px;">
<img class="pojedinosti" src="slike/tabela6.jpg" alt="BMW 118i" id="sestaSlikaUTabeli" style="width: 300px; height: 300px;">
      ...
      <form action="../../rezervacija.php" method="POST" id="rezervacija">
        ...
        <input type='hidden' name='slikaModela' value='modeli/Model1/slike/napraviSvoj/plavaBoja.jpg'>
