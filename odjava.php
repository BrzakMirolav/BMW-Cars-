...
<html lang="en">
          ...
          <a class="nav-link" href="modeli.php">Modeli</a>
            ...
            <li class="nav-item ">
              <?php 
                 ...
                 if(isset($_SESSION['korisnik'])){
                    if($_SESSION['status']=="Administrator" or $_SESSION['status']=="Korisnik")
                    echo "<a class='nav-link active' href='odjava.php'>"."Odjava"."</a>";             
  ...
  <body>
      ...
      <div class="reg">  <!--Pocetak registracionog diva-->
      <br>
     
      <h1>ODJAVA</h1> <br> 


       <form action="index.php?odjava" method="get">
       
       <input type="button" name="odj" class="sub" value="Odjavi se" onclick="location.href='index.php?odjava'"> <br><br>

      

      

      <!--  <a href="odjava.php" style="text-decoration:none;">Odjavi se</a> <br> <br> -->
