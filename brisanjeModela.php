      ...
      <div class="container-fluid" style="width: 100%; padding: 10px;">  <!--Pocetak Body kontejnera-->               
       ...
       $konekcija = mysqli_connect("sql306.epizy.com", "epiz_28113732", "RtEZ630f1aYz", "epiz_28113732_w316");
        ...
        if($rezultat = mysqli_query($konekcija, $upitZaListanjeModela)) {
            ...
            while ($row = mysqli_fetch_assoc($rezultat)) {
                echo "<option value='nazivModela=". $row['imeModela'] . "'>" . $row['imeModela']. "</option>";
        ...
        <br><br>
        <button id="brisanjeModela" class="sub">Obriši model</button>
   ...
   if(isset($_GET['nazivModela']))
    {
            ...
            $upitZaBrisanjeSlika= "DELETE FROM slike WHERE nazivModela='".$_GET['nazivModela']. "'" ;
            $upitZaBrisanjeModela = "DELETE FROM model WHERE imeModela='".$_GET['nazivModela']. "'";
           if(mysqli_query($konekcija, $upitZaBrisanjeSlika) and mysqli_query($konekcija, $upitZaBrisanjeModela)){
           echo "<script>alert('Uspešno si obrisao model');</script>";
           echo("<script>location.href = '/BMW/brisanjeModela.php';</script>");
           }
            mysqli_close($konekcija);
}*/
          ...
          if(isset($_GET['nazivModela']))
    {
          ...
          //  $upitZaBrisanjeSlika= "DELETE FROM slike WHERE nazivModela='".$_GET['nazivModela']. "'" ;
            $upitZaBrisanjeModela = "UPDATE model SET Obrisan=1 WHERE imeModela='".$_GET['nazivModela']. "'";
           if(mysqli_query($konekcija, $upitZaBrisanjeSlika) and mysqli_query($konekcija, $upitZaBrisanjeModela)){
           echo "<script>alert('Uspešno si obrisao model');</script>";
           echo("<script>location.href = '/BMW/brisanjeModela.php';</script>");
           }
...
<script>
$("#brisanjeModela").click(function() {
    let model = $("#listaModela :selected").val(); 
    window.location = 'brisanjeModela.php?' + model;
});
</script>